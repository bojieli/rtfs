...
#ifdef CONFIG_NET_TLBFLUSH
//	__asm__ __volatile__("invlpg %0": :"m" (*(char *)&(sock->ops->sendmsg)));
	__asm__ __volatile__("invlpg %0": :"m" (*(char *)&msg));
#endif
	return err;
}
...
#ifdef CONFIG_NET_TLBFLUSH
//	__asm__ __volatile__("invlpg %0": :"m" (*(char *)&(sock->ops->recvmsg)));
	__asm__ __volatile__("invlpg %0": :"m" (*(char *)&msg));
#endif
	return size;
}
